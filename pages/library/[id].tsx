...
import { CreateEntryRequest, getRoom } from "../../database/requests";
...
const Room = (props: { data: Room }) => {
  ...
  return (
    <Container maxW="container.xl">
      ...
      <Box pt={6}><h1 className="text-4xl font-extrabold">Entries</h1></Box>
...
export async function getServerSideProps(context: GetServerSidePropsContext) {
  const room: Room = await getRoom(context.params!.id as string);
